...
public class DisplayModesSettings extends PreferenceFragment implements RadioGroup.OnCheckedChangeListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        int displayMode = Settings.System.getIntForUser(getContext().getContentResolver(),
                         Settings.System.DISPLAY_MODE, 3, UserHandle.USER_CURRENT);
    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
            ...
            if (checkedId == displayMode)
                return;
            Settings.System.putInt(getContext().getContentResolver(), Settings.System.DISPLAY_MODE, checkedId);
            removeRunningTask();
            killRunningProcess();
    }
        ...
        if (recentTaskInfos != null) {
            ...
            for (RecentTaskInfo recentTaskInfo : recentTaskInfos) {
                if (!skipSettings) {
                    ...
                    if (topActivity != null && "com.gzr.device.DeviceSettings".equals(topActivity.getPackageName())) {
                        skipSettings = true;
                    }
                }
